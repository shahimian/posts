...
<div>
    ...
    <option selected>قالب بندی</option>
    ...
    <option value="h6">زیر عنوان &lt;h6&gt;</option>
    <option value="p">پاراگراف &lt;p&gt;</option>
    <option value="pre">پیش قالب بندی شده &lt;pre&gt;</option>
    </select>
    <select onchange="formatDoc('fontname',this[this.selectedIndex].value);this.selectedIndex=0;">
    <option class="heading" selected>فونت</option>
    <option>Arial</option>
    ...
    <option class="heading" selected>اندازه فونت</option>
    <option value="1">خیلی کوچک</option>
    <option value="2">کوچک</option>
    <option value="3">متوسط</option>
    <option value="4">تقریباً بزرگ</option>
    <option value="5">بزرگ</option>
    <option value="6">خیلی بزرگ</option>
    <option value="7">بزرگترین اندازه</option>
    </select>
    ...
    <option class="heading" selected>پیش زمینه</option>
    <option value="red">قرمز</option>
    <option value="green">سبز</option>
    <option value="black">سیاه</option>
    </select>
...
<div id="textBox" contenteditable="true"><?= $post ?></div>
<p id="editMode"><input type="checkbox" name="switchMode" id="switchBox" onchange="setDocMode(this.checked);" /> <label for="switchBox">نمایش HTML</label></p>
</div>